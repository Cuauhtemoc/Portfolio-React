...
class Projects extends Component{
    render(){
        return(
            <div id ="projects" className='container text-center'style={{height:"100vh"}}>
                ...
                <div className="row">
                    ...
                    <Card projectDescription="A party planning app. Users can create lists of items to share with their guests. Guests can then swipe right or left they will or will not be bringing" projectName="Who's Bringing the Dip" herokuLink="http://thedip.herokuapp.com/" githubLink="https://github.com/Cuauhtemoc/The-dip" imgPath={theDipImg}/>
